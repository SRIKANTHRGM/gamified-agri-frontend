...
import Step1 from "../assets/tomato1.png";
import Step2 from "../assets/tomato2.png";
import Step3 from "../assets/tomato3.png";
import Step4 from "../assets/tomato4.png";
import Step5 from "../assets/tomato5.png";
...
function TomatoGame() {
  ...
  const steps = [
    ...
    { name: "Transplant Seedlings", image: Step2, points: 10 },
    ...
    <div style={{ minHeight: "100vh", background: "#f8fff6", fontFamily: "'Segoe UI', sans-serif" }}>
      <div style={{ textAlign: "center", margin: "40px 0 20px" }}>
        ...
        <p style={{ background: "#fff", display: "inline-block", padding: "10px 25px", borderRadius: "16px", boxShadow: "0 2px 12px #b5c9a666", fontSize: "1.1rem", fontWeight: 500, color: "#236c1d", margin: "20px 0" }}>
          Complete each step and grow your tomato farm! 🌱
        </p>
      </div>
